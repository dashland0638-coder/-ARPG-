...
src/
  ...
  core/pose-geometry.js        構えの順運動学と幾何チェック(刃が頭/胴を
                                ...
                                座標を使う
  core/head-rig.js             視線。頭に「体と腰がまだ向けていない残り」だけを
                                持たせる角度計算と、首の可動域
...
頭に持たせるのは「体と腰がまだ向けていない残り」だけ。これで腰が半身に捻れていれば頭はその分を戻し、体が正面を向けば頭も自然に正面へ戻る ―― 弓師の残心(弓を収め終えても体は半身のまま、視線だけ敵へ)が、専用の分岐を1つも書かずに成立する。
