...
// into one shared scope at build time; see src/legacy/concat-plugin.js)
  ...
  function buildMansion(){
    ...
    buildLoreNote(new THREE.Vector3(-3,0,-44), '色あせた日記の一頁', [
      '「妻と娘を失って、もう半年になる。医者にできることは、何もなかった」',
      '「代償が魂だとしても、私は構わない。あの二人を取り戻せるなら」',
  ...
  function buildSecondFloor(){
    ...
    // 書斎の隅、机に向かって書き続ける影。近づくと消える ―― 妻と娘を
    // 蘇らせる術を探し始めた頃、まだ後戻りできた頃の残影(洋館の"幻影再生"、
    // 書斎ルート編)
    ...
    buildLoreNote(new THREE.Vector3(cx+2.5, 0, czStudy-6), '肖像画の裏書き', [
      '「お前たちが、本当の姿を取り戻す日まで、私はここで待ち続けよう」',
