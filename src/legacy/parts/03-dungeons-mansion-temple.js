...
// into one shared scope at build time; see src/legacy/concat-plugin.js)
  ...
  function buildClocktower(){
    ...
    // 鐘の間、老いた技師とおぼしき影が背を向けて立っている ―― 「後ろに
    // 立つのは先生ではない」という譜面の書き込みに対応する演出
  ...
  function buildConservatory(){
    ...
    // 扉の前、如雨露を提げたまま振り返る園丁長の影。近づくと消える
    // ―― 「最後の水やりは、私がする」という手紙の一文に対応する演出
  ...
  function buildTemple(){
    ...
    // 祭壇の傍ら、旅装に真新しい荷袋を提げた人影が立っている。近づくと
    // 消える ―― やがて自分がそこに立つかもしれない、という予感の演出
    registerProximityEvent(new THREE.Vector3(140,0,-125), 8, '???', ()=>{
      ...
      return [
        '祭壇の傍ら、旅装のまま佇む人影がある。荷袋はまだ真新しい。',
        '目が合った――そう感じた瞬間、姿は消えていた。'
      ];
    });
